      ...
      <div class="col-lg-8 col-md-9 col-sm-12 col-xs-12 pull-center">
        <div class="full">
          <div class="blog_section margin_bottom_0">
            <div class="blog_feature_img"> <img class="img-responsive" src="assets/web/images/it_service/post-05.jpg" alt="#"> </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-9 col-xs-9">
        <div class="full">
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="assets/web/images/it_service/22.jpg" alt="#"> </div>
            <div class="blog_feature_cantant">
              <p class="blog_head">Blogpost With Image</p>
              <div class="post_info">
                <ul>
              ...
              <div class="bottom_info">
                <div class="pull-left"><a class="read_more" href="<?php echo base_url() ?>noticia">Leer Mas <i class="fa fa-angle-right"></i></a></div>
                <div class="pull-right">
                  <div class="shr">Share: </div>
                  <div class="social_icon">
                    <ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        <div class="full">
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="assets/web/images/it_service/dark_bg_img2.png" alt="#"> </div>
            <div class="blog_feature_cantant">
              <p class="blog_head">Blogpost With Image</p>
              <div class="post_info">
                <ul>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
        <div class="full">
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="assets/web/images/it_service/post-03.jpg" alt="#"> </div>
          </div>
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="assets/web/images/it_service/dark_bg_img.png" alt="#"> </div>
          </div>
        </div>
      </div>      
    </div>
