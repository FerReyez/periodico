...
<html lang="es">
<head>
    <title>Iniciar sesión | INTESAL</title>
    <meta charset="UTF-8">
            ...
            <div class="wrap-login100">
                <div class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Usuario requerido">
                        <input class="input100" type="email" name="username" id="username" placeholder="CORREO" required="" 
                        value="<?php if (isset($_SESSION['correo'])): ?>
                ...
                <?php endif ?>
                    ...
                    <div class="text-center p-t-46 p-b-20">
                        <span class="txt2">
                            ¿Olvidaste tu contraseña?<br>Ponte en contacto con el administrador del sistema <br> ( <a href="mailto:tucorreo@.com">tucorreo@.com</a> )
                        </span>
                    </div>
