    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $.each(response.ediciones, function(key, item) {
                    ...
                    filas += '<br/>';
                    filas += '<div class="pull-left"><a class="btn sqaure_bt" id="btnEdicion" data-btnEdicionId="'+item.id_edicion+'" href="<?= base_url() ?>noticias_lista">Leer Mas<i class="fa fa-angle-right"></i></a></div>';
